...
import HautevilleHouse.DynamicalSystemsInvolvingTransformationsGroupTheoremCanonicalLaneLean.FinalTheorem
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "dynamical-systems-involving-transformations-group-theorem",
  theoremObject := "Dynamical Systems Involving Transformations Group Theorem",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedDynamicalClosure A
